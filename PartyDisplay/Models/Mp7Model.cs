...
public class Mp7Model : DolphinModel<Mp7Reader, Mp7Orb> {
    public Mp7Model() {
        ...
        bonusStars = [
            [Mp7.BonusStars[0].Clone(), Mp7.BonusStars[1].Clone(), Mp7.BonusStars[2].Clone(), Mp7.BonusStars[3].Clone(), Mp7.BonusStars[4].Clone(), Mp7.BonusStars[5].Clone()],
            [Mp7.BonusStars[0].Clone(), Mp7.BonusStars[1].Clone(), Mp7.BonusStars[2].Clone(), Mp7.BonusStars[3].Clone(), Mp7.BonusStars[4].Clone(), Mp7.BonusStars[5].Clone()],
            [Mp7.BonusStars[0].Clone(), Mp7.BonusStars[1].Clone(), Mp7.BonusStars[2].Clone(), Mp7.BonusStars[3].Clone(), Mp7.BonusStars[4].Clone(), Mp7.BonusStars[5].Clone()],
            [Mp7.BonusStars[0].Clone(), Mp7.BonusStars[1].Clone(), Mp7.BonusStars[2].Clone(), Mp7.BonusStars[3].Clone(), Mp7.BonusStars[4].Clone(), Mp7.BonusStars[5].Clone()]
        ];
    ...
    public override async Task UpdateLoop() {
        if (PlayerConnection is not null) {
            ...
            bonusStars[0][4].Count = Reader.GetOrbsBought(0);
            bonusStars[1][4].Count = Reader.GetOrbsBought(1);
            bonusStars[2][4].Count = Reader.GetOrbsBought(2);
            bonusStars[3][4].Count = Reader.GetOrbsBought(3);
